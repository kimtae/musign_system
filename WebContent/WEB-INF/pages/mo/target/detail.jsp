...
<div class="mu_content calculate_margin sy_wrap front_h fr_detail">
	<div class="mu_inner">
		<div class="mu_top">
			<div class="mu_top2">
				<h3 class="mu_title">
					<span class="maintenance_icon"></span>
					<span>유지보수 상세현황</span>
				</h3>
<!-- 				<div class="mu_mypage"> -->
...
<!-- 				</div> -->
			...
			<a href="" class="mu_back">리스트로 돌아가기</a>
		</div>
		<div class="mu_bottom">
			<div class="mu_bottom_01">
				...
				<div class="mu_progress">
					...
					<div class="mu_drop">
						<a href="#" class="report_down">리포트 다운로드</a></div>
<!-- 						<h2 class="mu_title3">진행 상태</h2> -->
<!-- 							<div class="mu_drop drop_line pro_drop"> -->
...
<!-- 							</div> -->
	...
	<div id="sub_offer_area" class="sub_area">
		<jsp:include page="/WEB-INF/pages/mo/target/sub_offer.jsp"/> <br>
	</div>
	
	<!-- 상세 업무 현황 영역 -->
	<div id="sub_work_status_area" class="sub_area">
		<jsp:include page="/WEB-INF/pages/mo/target/sub_work_status.jsp"/><br>
	</div>
	
	<!-- 캘린더 영역 -->
	<div id="sub_calender_area" class="sub_area">
		<jsp:include page="/WEB-INF/pages/mo/target/sub_calender.jsp"/><br>
	</div>
	
	<!-- 관리자 메모 영역 -->
	<div id="sub_memo_area" class="sub_area memo_area">
		<jsp:include page="/WEB-INF/pages/mo/target/sub_memo.jsp"/><br>
	</div>
	
	<!-- 정산 설정 영역 -->
	<div id="sub_set_area" class="sub_area set_area">
		<jsp:include page="/WEB-INF/pages/mo/target/sub_set.jsp"/><br>
	</div>
</div>
</div>
...
<%-- <jsp:include page="/WEB-INF/pages/mo/common/footer.jsp"/> --%>