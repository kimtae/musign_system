...
<div class="mu_contents_lr calendar_area fr_main">
		...
		<div class="content">
			<div class="calendar_top half_cont">
				...
				<div class="mu_money popup_wrap">
					<button type="button" class="add_item wide_btn show">캘린더 추가</button>
	...
	//alert(inner);
			...
			<!-- <div class="calendar_slide">
			    <table id="calendar">
			        <tr class="c_year">
			            label은 마우스로 클릭을 편하게 해줌
			            <td class="cal_btn btn_left" colspan="2"><span onclick="prevCalendar()"> ◀  </span> </td>
			            <td align="center" id="tbCalendarYM" colspan="3">
			                yyyy년 m월</td>
			            <td class="cal_btn btn_right" colspan="2"><span onclick="nextCalendar()"> ▶  </span></td>
			        </tr>
			        <tr id="c_day">
			            <td align="center">일 </td>
			            <td>월</td>
